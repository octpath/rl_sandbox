...
class Reversi:
    ...
    def __init__(self, num_rows=6, num_cols=6):
        ...
        self.action_space_dims = self.num_cols * self.num_rows + 1
        self.action_noop = self.action_space_dims - 1
        self.sente = 1
        self.gote = -1
    ...
    def get_state_2d(self, state):
        return state.reshape((self.num_rows, self.num_cols))
    ...
    def get_greedy_action(self, state, player, epsilon=0.0):
    ...
    def save_img(self, state, save_dir, fname, comment):
        ...
        height = 50 * self.num_rows
        width = 50 * self.num_cols
        ...
        for i in range(self.num_rows * self.num_cols):
            v = state[i]
            row, col = i // self.num_rows, i % self.num_cols
